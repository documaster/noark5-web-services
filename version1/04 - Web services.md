...
- **results**
  ...
  - **fields**
    ...
    - **virksomhetsspesifikkeMetadata** (optional)
      ...
      - will be returned (if present) only for objects of type *Mappe*, *Moetemappe*, *Saksmappe*, *Sakspart*, *Registrering*, *Moeteregistrering*, *Journalpost*, and *Korrespondansepart*
      - **groupId**
...
- **fields** (optional)
  ...
  - **virksomhetsspesifikkeMetadata** (optional)
    ...
    - may be specified only for objects of type *Mappe*, *Moetemappe*, *Saksmappe*, *Sakspart*, *Registrering*, *Moeteregistrering*, *Journalpost*, and *Korrespondansepart*
    - **groupId**
